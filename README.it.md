...
**Star Freight** è un gioco di ruolo mercantile tattico basato principalmente sul testo, in cui trasporti merci attraverso un sistema stellare politicamente diviso. Cinque civiltà. Un'unica economia. Quattro verità che non ti permetteranno di vivere la stessa vita due volte.
...
La maggior parte dei giochi di ruolo impilano i sistemi uno accanto all'altro. Star Freight fa sì che interagiscano.
...
**Il combattimento è un evento della campagna.** Non entri in una battaglia e ne esci subito. La vittoria ti fa guadagnare crediti di recupero e aumenta la tua reputazione con le fazioni. La ritirata costa il carico abbandonato e una reputazione di codardo. La sconfitta significa merci sequestrate, membri dell'equipaggio feriti e una nave che arriva a stento alla stazione più vicina, a un prezzo elevato. Ogni esito cambia la tua prossima decisione commerciale.
...
**La Keth Communion** — Collettivo di artropodi con un calendario biologico. Pazienti, osservatori e devastanti quando vengono offesi. I migliori margini del sistema se capisci le stagioni. Il crollo più rapido della reputazione se non lo fai.
...
**The Sable Reach** — Fazioni piratesche, recuperatori di tecnologia antica e persone che la Compagnia preferirebbe dimenticare. Nessuna legge. Nessuna consuetudine. Nessun rimborso. Il rischio più alto e la ricompensa più grande del sistema.

## Tre tipi di capitano

Lo stesso mondo. Tre pressioni diverse.

**Capitano di supporto.** Disciplina del convoglio, accesso basato sulla fiducia, conseguenze pubbliche. Mantenete le persone nutrite e rimanete intrappolati nella legittimità. Temete i ritardi e la capacità insufficiente.

**Corriere grigio.** Pressione burocratica, sfruttamento dei tempi, rischio istituzionale. Guadagnate denaro rimanendo enigmatici. Temete le confische e le rivelazioni.
...
Queste non sono classi. Sono ciò che le vostre scelte vi hanno trasformato.
...
La versione preliminare ha superato tutti e tre i criteri di verifica: Percorso ottimale (vita del capitano coerente), Incontri (tre percorsi con diversi stati della campagna) e Economia (la pressione si mantiene senza degenerare in ripetitività).

Sono stati distribuiti tre pacchetti di espansione: Working Lives (approfondimento della condizione umana), Houses, Audits, and Seizures (pressione istituzionale) e Shortages, Sanctions, and Convoys (scarsità controllata).

La divergenza del percorso del capitano è stata dimostrata: tre approcci producono percorsi diversi, mix commerciali diversi, profili di combattimento diversi, texture di fallimento diverse e identità di capitano diverse.

## Tecnologia

Python 3.11+. Interfaccia utente testuale avanzata. Derivato da [Portlight](https://github.com/mcp-tool-shop-org/portlight) — un motore di strategia marittima con 1.832 test che fornisce la simulazione commerciale, il modello economico e l'architettura dello stato del mondo. Star Freight aggiunge funzionalità come la gestione dell'equipaggio, il combattimento a griglia, la conoscenza culturale, l'indagine e l'organizzazione della campagna.

Nessuna dipendenza da intelligenza artificiale esterna. Nessun servizio cloud. Funziona sulla vostra macchina.

## La regola fondamentale

Quando non siete sicuri di cosa sviluppare successivamente:

- Rafforza una delle quattro verità fondamentali?
- Migliora la vita del capitano?
