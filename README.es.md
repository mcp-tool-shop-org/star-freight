<p align="center">
  <a href="README.ja.md">日本語</a> | <a href="README.zh.md">中文</a> | <a href="README.md">English</a> | <a href="README.fr.md">Français</a> | <a href="README.hi.md">हिन्दी</a> | <a href="README.it.md">Italiano</a> | <a href="README.ko.md">한국어</a> | <a href="README.pt-BR.md">Português (BR)</a>
</p>
...
Aterrizas en estaciones donde la cultura influye en cómo negocias. Eliges rutas donde el terreno afecta a cómo luchas. Contratas a la tripulación, que cambia lo que puedes hacer, a lo que puedes acceder y lo que debes. Aceptas contratos que parecen sencillos hasta que la burocracia se complica, la escasez cambia el precio o la carga resulta ser evidencia.
...
**El combate es un evento de campaña.** No entras en una batalla y sales de ella. La victoria genera créditos de rescate y "calor" de facción. La retirada cuesta carga abandonada y una reputación de cobarde. La derrota significa carga confiscada, tripulación herida y una nave que llega a la estación más cercana a un precio elevado. Cada resultado cambia tu próxima decisión comercial.
...
**Los Principados Veshan** — Casas feudales reptilianas obsesionadas con el honor y la deuda. Luchan formalmente, comercian directamente y recuerdan todo. El Libro de Deudas no es solo un detalle. Es un punto de apalancamiento.
...
**Capitán de logística.** Disciplina de convoy, acceso basado en la confianza, consecuencias públicas. Mantienes a la gente alimentada y te ves atrapado por la legitimidad. Temes los retrasos y la falta de capacidad.

**Contrabandista.** Palanca a través de documentos, abuso del tiempo, riesgo institucional. Ganas dinero siendo difícil de descifrar. Temes el decomiso y la exposición.
...
Estas no son clases. Son lo que tus elecciones te convirtieron.
...
| Estaciones | 9 |
| Rutas espaciales | 14 |
| Bienes comerciales | 18 |
| Miembros de la tripulación | 5 + jugador |
| Contratos | 9 |
| Encuentros | 6 |
| Pistas de investigación | 4 |
| Pruebas superadas | 2,161 |

La versión completa ha superado los tres criterios de prueba: Camino Dorado (vida de capitán continua), Encuentro (tres ramas con diferentes estados de campaña) y Economía (la presión se mantiene sin colapsar en una repetición constante).

Se han lanzado tres paquetes de expansión: Working Lives (textura humana), Houses, Audits, and Seizures (presión institucional) y Shortages, Sanctions, and Convoys (escasez controlada).

La divergencia del camino del capitán está probada: tres posturas producen diferentes rutas, diferentes combinaciones comerciales, diferentes perfiles de combate, diferentes texturas de fracaso y diferentes identidades de capitán.

## Tecnología

Python 3.11+. Interfaz de texto enriquecida. Derivado de [Portlight](https://github.com/mcp-tool-shop-org/portlight) — un motor de estrategia marítima con 1832 pruebas que proporciona la simulación comercial, el modelo económico y la arquitectura del estado del mundo. Star Freight añade a esto la gestión de la tripulación, el combate por cuadrícula, el conocimiento cultural, la investigación y la orquestación de la campaña.

No hay dependencias de IA externas. No hay servicios en la nube. Se ejecuta en tu máquina.

## La regla general

Cuando no estés seguro de qué construir a continuación:

- ¿Refuerza una de las cuatro verdades?
